...
app.post('/todos', async (req, res) => {
    ...
    try {
        ...
        const [result] = await connection.query('INSERT INTO todos (title, description) VALUES (?, ?)', [title, description]);
...
app.put('/todos/:id', async (req, res) => {
    ...
    try {
        const connection = await db.getConnection()
        const [result] = await connection.query('UPDATE todos SET title = ?, description = ?, completed = ? WHERE id = ?', 
